...
class BertModel_PoolActivation(BertPreTrainedModel):
...
class BERT_withPoolActivation(nn.Module):
    def __init__(self, num_classes=3, bert_type='bert-large-cased'):
        super(BERT_withPoolActivation, self).__init__()
        assert bert_type == 'bert-large-cased' or bert_type == 'bert-base-cased'
        
        self.bert = BertModel_PoolActivation.from_pretrained(bert_type)
        self.dropout = nn.Dropout(0.1)
        if bert_type == 'bert-base-cased':
            self.classifier = nn.Linear(768, num_classes)
        elif bert_type == 'bert-large-cased':
...
class BertWithAllEdits(BertPreTrainedModel):
...
class BERTAllInOne(nn.Module):
    def __init__(self, num_classes=3, bert_type='bert-base-cased'):
        super(BERTAllInOne, self).__init__()
        assert bert_type == 'bert-large-cased' or bert_type == 'bert-base-cased'
        
        self.bert = BertWithAllEdits.from_pretrained(bert_type)
        self.dropout = nn.Dropout(0.1)
        if bert_type == 'bert-base-cased':
            self.classifier = nn.Linear(768, num_classes)
        elif bert_type == 'bert-large-cased':
...
###################for pre-finetuning task ############################
class BERTwithMSRP(nn.Module):
    def __init__(self, num_classes=2, bert_type='bert-base-cased'):
        super(BERTwithMSRP, self).__init__()
        assert bert_type == 'bert-large-cased' or bert_type == 'bert-base-cased'
        self.bert = BertModel.from_pretrained(bert_type)
        self.dropout = nn.Dropout(0.1)
