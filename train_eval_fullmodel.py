from dataprocessing import BERTMNLIWithWordMaskingAndLossEdit, BERTMNLIWithWordMasking
import torch
import torch.nn as nn
from model import BERTAllInOne
...
if __name__ == '__main__':
    mnli = BERTMNLIWithWordMaskingAndLossEdit(TRAIN_DATA_DIR, bert_type=BERT_TYPE)
    ...
    model = BERTAllInOne(bert_type=BERT_TYPE)
    model.to(device)
